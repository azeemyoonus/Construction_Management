...
public class ConstructionManagment implements ActionListener {
    ...
    public ConstructionManagment() {
        ...
        JLabel headingLabel = new JLabel("<html>Welcome To <font color='#d1c4b2'> Albatross Builders <br><center>You Want It We Build It</font> </center><center><font color='#ebc38a'> Login As</font></font></center></html>");
        ...
        supervisorLoginBtn.setBounds(28+(2*(int)screenSize.getWidth()/3), 55, ((int)screenSize.getWidth())/4, 50);
